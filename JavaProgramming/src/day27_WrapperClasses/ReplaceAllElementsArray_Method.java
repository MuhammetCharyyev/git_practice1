...
public class ReplaceAllElementsArray_Method {
    ...
    public static void main(String[] args) {
        ...
        arr = replaceAllElements(arr, 30, 300); //==> {10, 10, 20, 300, 40, 300, 300, 300}
    ...
    // replace all int elements by new elements
    ...
    // replace all double elements by new elements
    ...
    // replace all char elements by new elements
    ...
    // replace all String elements by new elements
